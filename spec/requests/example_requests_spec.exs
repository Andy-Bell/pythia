defmodule Pythia.PostsRequestsSpec do
  use ESpec.Phoenix, request: Pythia.Endpoint

  describe "index" do
    before do
      ex1 = %Pythia.Example{title: "Example 1"} |> Pythia.Repo.insert
      ex2 = %Pythia.Example{title: "Example 2"} |> Pythia.Repo.insert
      {:ok, ex1: ex1, ex2: ex2}
    end
